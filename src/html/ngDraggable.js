 ...
 * modifications made by David Moritz for creating promise calls.
 */
        ...
        .directive('ngDrag', ['$rootScope', '$parse', '$document', '$window', 'ngDraggable', function ($rootScope, $parse, $document, $window, ngDraggable) {
            return {
                ...
                link: function (scope, element, attrs) {
                    ...
                    var onDragComplete = function(resolve) {
                        var evt = this;

                        if (!onDragSuccessCallback )return;

                        scope.$apply(function () {
                            onDragSuccessCallback(scope, {$data: _data, $event: evt, $resolve: resolve});
                        });
                    };
                    ...
                    var onDragEnd = function (evt, obj) {
                        ...
                        if (isTouching(obj.x, obj.y, obj.element)) {
                           ...
                           if(obj.callback && !attrs.ngDragCancel){
                                var p = new Promise(obj.callback.bind(obj));
                                p.then(() => {
